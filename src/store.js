...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setSinglePhotoID(state, id)
    {
      state.singlePhotoID = id;
      console.log("setting single photo id to: ");
      console.log(id);
    },
  },
  actions: {
    ...
    async setNewSinglePhotoID(context, id)
     {
       context.commit("setSinglePhotoID", id);
       return "";
     },
